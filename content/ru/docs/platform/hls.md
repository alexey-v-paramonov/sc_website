...
- **Нет статистики слушателей в реальном времени**: в отличие от Icecast или SHOUTcast, HLS передаётся так же, как обычные файлы через HTTP, поэтому **невозможно точно подсчитать количество одновременных слушателей** или отследить, кто именно слушает.
