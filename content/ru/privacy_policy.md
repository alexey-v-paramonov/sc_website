...
Эта Политика Конфиденциальности описывает условия получения и использования информации сервисом «Радио-Точка» и мобильными приложениями для прослушивания Интернет-радио, разработанные сервисом «Радио-Точка», наименование разработчика в магазине **Goole Play**: «iRadioService».
