...
seo_title: "Утилиты администрирования сервера Интернет-радио | Радио-Точка"
description: "Консольные утилиты для управления платформой «Радио-Точка» через SSH: смена паролей администратора и пользователей, обновление домена, настройка SSL-сертификата."
---
