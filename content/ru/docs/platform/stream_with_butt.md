...
BUTT (Broadcast Using This Tool: дословно "вещай, используя этот инструмент" с англ.) — это бесплатный open-source энкодер для live-вещания Интернет-радио. Программа захватывает звук с выбранного источника (микрофон, микшер, линейный вход или виртуальное аудиоустройство), кодирует его и отправляет напрямую на стриминговый сервер.
