...
Each social network destination costs **$9 per month** and includes a **48-hour free trial**. You can enable and disable destinations separately in your account.

[Start social streaming](https://app.streaming.center/social) or read the [account setup guide]({{< ref "/docs/radio/social_streaming" >}}).
