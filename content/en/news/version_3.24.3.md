...
- "Delete radio" button was moved out from the top bar into the "Settings" section not to confuse users, who often remove radio by mistake using the button at the top.
- Jingles and Jingle blocks now have on/off checkbox directly in the list allowing users to toggle many jingles at once.
