...
seo_title: "Ускорение обработки файлов, новые настройки сетки вещания"
description: "Для событий в сетке вещания введена новая опция - для плейлистов, которые не случайные, а играют по порядку, теперь возможно убрать галочку \"Начать плейлист..."
---
