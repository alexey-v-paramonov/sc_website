...
seo_title: "Часто задаваемые вопросы | Интернет-радио Радио-Точка FAQ"
description: "Ответы на частые вопросы об Интернет-радио: проблемы при прослушивании, Live-вещание, использование собственного домена, авторские отчисления РАО/ВОИС и способы оплаты."
---

1. Во время прослушивания, радио прерывается, буферизирует или вообще не играет.
   
   В 99% случаев причина — плохая связь между устройством, на котором Вы слушаете радио, и сервером, с которого идёт поток. Даже при высокоскоростном проводном подключении пакеты на пути от Вашего провайдера к серверу могут проходить через множество других узлов и провайдеров, и на каком-либо из промежуточных узлов может возникнуть проблема.
