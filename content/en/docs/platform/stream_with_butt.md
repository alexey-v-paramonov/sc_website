...
The setup described in this article applies **exclusively** to the **Streaming.Center** internet radio control panel and uses streaming credentials generated in your Streaming.Center account.
...
To connect from BUTT, you will need the following three parameters provided by the **Streaming.Center** control panel:
