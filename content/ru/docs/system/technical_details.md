...
seo_title: "Техническое описание платформы Интернет-радио | Радио-Точка"
description: "Архитектура платформы «Радио-Точка»: интерфейсы администратора и вещателя, вещательное ядро Авто-Диджей, зависимости Nginx/MySQL/Python и инструменты диагностики."
---
...
Она также зависит от системных сервисов операционной системы Linux, таких как Nginx, Apache, MySQL, Cron, Supervisord, ProFTPd, FFMPEG, Python и различные системные библиотеки.
