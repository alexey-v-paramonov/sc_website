...
seo_title: "Резервное копирование платформы Интернет-радио | Радио-Точка"
description: "Как настроить резервное копирование сервера Интернет-радио «Радио-Точка»: полные и компактные бэкапы настроек и базы данных, перенос сервера и защита данных пользователей."
---
...
7. Установить домен для радио с помощью команды `cd /opt/bin && ./change_host`.
