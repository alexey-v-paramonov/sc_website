...
seo_title: "Системные требования для платформы Интернет-радио | Радио-Точка"
description: "Технические требования к серверу для платформы «Радио-Точка»: процессор, ОЗУ, дисковое пространство и полоса пропускания в зависимости от количества радиостанций и слушателей."
---

В этой статье мы расскажем про системные требования к серверу для стабильной работы нашей Платформы Интернет радио, а [здесь Вы можете найти пошаговое руководство по аренде подходящего сервера у провайдера FirstVDS](/docs/system/hosting).
