...
seo_title: "Поддержка протокола HTTPS"
description: "Добавлена поддержка протокола HTTPS для радио потоков Icecast, теперь плееры смогут работать на страницах, загруженных по HTTPS: читать подробно."
---
