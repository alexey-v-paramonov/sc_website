...
seo_title: "Что такое Интернет-радио и как оно работает | Радио-Точка"
description: "Как работает Интернет-радио: потоковое вещание через Icecast и Shoutcast, аудиоформаты MP3/AAC/FLAC, отличия от музыкальных сервисов и преимущества перед традиционным FM-радио."
---
...
Слушатели подключаются через приложения, веб-сайты или совместимые устройства. Для вещания используются протоколы HTTP, HTTPS и аудио-кодеки (MP3, AAC, AAC++, OPUS, FLAC, OGG Vorbis) для эффективной передачи аудио.
