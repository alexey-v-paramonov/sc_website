...
- fully supports Cyrillic and special characters in filenames,
- available for Windows, macOS, and Linux,
- equipped with an intuitive interface,
- ideal for managing and updating files on your radio hosting.

👉 **Download FileZilla from the official website**: [https://filezilla-project.org/](https://filezilla-project.org/)

We recommend installing **FileZilla Client** (not Server!). The program is only about 4–5 MB in size.
...
> ⏱️ **Important!**  
> The server automatically scans folders every few minutes. New tracks usually appear in the **“Playlists”** section of your control panel within **5 minutes** after upload. Once indexed, Auto-DJ will begin playing them automatically.
