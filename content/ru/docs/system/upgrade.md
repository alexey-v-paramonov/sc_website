...
seo_title: "Обновление платформы Интернет-радио | Радио-Точка"
description: "Как обновить платформу «Радио-Точка» до последней версии: подключение к серверу по SSH и выполнение команды обновления для Linux/macOS и Windows через PuTTY."
---
